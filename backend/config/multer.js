...
// import { CloudinaryStorage } from "multer-storage-cloudinary";
// import multer from "multer";
// import cloudinary from "./cloudinary.js"; // Corrected import path
// import roleModel from "../models/role-model.js";

// const storage = new CloudinaryStorage({
//   cloudinary,
//   params: async (req, file) => {
//     let folderName = "support_app/profile_photos"; // Default folder
//     const role = await roleModel.findById(req.body.role).select("roleName -_id");
//     if (role) {
//       if (role.roleName === "admin") {
//         folderName = "support_app/admin_photos";
//       } else if (role.roleName === "HR") {
//         folderName = "support_app/hr_photos";
//       } else {
//         folderName = "support_app/profile_photos";
//       }
//     }
//     return {
//       folder: folderName,
...
// //   cloudinary,
// //   params: {
// //     folder: "support_app", // Name of the folder where images are stored
// //     allowed_formats: ["jpg", "png", "jpeg", "webp"],
// //     // transformation: [{ width: 800, height: 600, crop: "limit" }], // Optimize size
// //   },
// // });
